...
class BTagSF(object):
    def __init__(self, csv = None, wp_key = None, effs = None):
        ...
        self.schema_ = { 
            ...
            "bc_correlated_up" : ("UDSG_central", "C_up_correlated", "B_up_correlated"),
            "bc_uncorrelated_up" : ("UDSG_central", "C_up_uncorrelated", "B_up_uncorrelated"),
            "bc_down" : ("UDSG_central", "C_down", "B_down"),
            "bc_correlated_down" : ("UDSG_central", "C_down_correlated", "B_down_correlated"),
            "bc_uncorrelated_down" : ("UDSG_central", "C_down_uncorrelated", "B_down_uncorrelated"),
            "l_up" : ("UDSG_up", "C_central", "B_central"),
            "l_correlated_up" : ("UDSG_up_correlated", "C_central", "B_central"),
            "l_uncorrelated_up" : ("UDSG_up_uncorrelated", "C_central", "B_central"),
            "l_down" : ("UDSG_down", "C_central", "B_central"),
            "l_correlated_down" : ("UDSG_down_correlated", "C_central", "B_central"),
            "l_uncorrelated_down" : ("UDSG_down_uncorrelated", "C_central", "B_central"),
