...
outdir = os.path.join(plot_outdir, jobid if args.combination == "era_lepton" else f"{args.year}_{jobid}", f"Compare_Smoothed_Combined_Templates_{analyzer}", (args.process).upper(), (args.combination).upper())
