...
for jmult in templates_names.keys():
    orig_dict = templates_names[jmult]["bkg"][args.lepton]
    ...
    if args.indiv:
        ...
        for sys in systs:
            ...
            for topo in topologies:
                ...
                #set_trace()
                figname = os.path.join(pltdir, "_".join([jmult, args.lepton, sys, topo, "Sys_Comp"]))
    ...
    if args.comp:
        ...
        for sys in systypes:
            ...
            for topo in topologies:
                ...
                #set_trace()
                figname = os.path.join(pltdir, "_".join([jmult, args.lepton, sys, topo, "SysTemplates_Comp"]))
