...
outdir = os.path.join(proj_dir, "plots", f"{args.year}_{jobid}", f"Templates_{analyzer}", "Symmetrized", args.lepton)
...
templates_names = {
    "3Jets" : {
        "bkg" : {
            "Orig" : load(os.path.join(input_dir, f"test_raw_templates_lj_3Jets_bkg_{args.year}_{jobid}.coffea")),
            "Smooth" : load(os.path.join(input_dir, f"test_SymmetrizedSmoothed_templates_lj_3Jets_bkg_{args.year}_{jobid}.coffea")),
            "Flat" : load(os.path.join(input_dir, f"test_SymmetrizedFlattened_templates_lj_3Jets_bkg_{args.year}_{jobid}.coffea")),
            },
        "sig" : {
            "Orig" : load(os.path.join(input_dir, f"test_raw_templates_lj_3Jets_sig_{args.year}_{jobid}.coffea")),
            "Smooth" : load(os.path.join(input_dir, f"test_SymmetrizedSmoothed_templates_lj_3Jets_sig_{args.year}_{jobid}.coffea")),
            "Flat" : load(os.path.join(input_dir, f"test_SymmetrizedFlattened_templates_lj_3Jets_sig_{args.year}_{jobid}.coffea")),
            },
    },
    "4PJets" : {
        "bkg" : {
            "Orig" : load(os.path.join(input_dir, f"test_raw_templates_lj_4PJets_bkg_{args.year}_{jobid}.coffea")),
            "Smooth" : load(os.path.join(input_dir, f"test_SymmetrizedSmoothed_templates_lj_4PJets_bkg_{args.year}_{jobid}.coffea")),
            "Flat" : load(os.path.join(input_dir, f"test_SymmetrizedFlattened_templates_lj_4PJets_bkg_{args.year}_{jobid}.coffea")),
            },
        "sig" : {
            "Orig" : load(os.path.join(input_dir, f"test_raw_templates_lj_4PJets_sig_{args.year}_{jobid}.coffea")),
            "Smooth" : load(os.path.join(input_dir, f"test_SymmetrizedSmoothed_templates_lj_4PJets_sig_{args.year}_{jobid}.coffea")),
            "Flat" : load(os.path.join(input_dir, f"test_SymmetrizedFlattened_templates_lj_4PJets_sig_{args.year}_{jobid}.coffea")),
            },
    },
}
