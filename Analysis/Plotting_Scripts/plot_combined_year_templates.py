...
outdir = os.path.join(proj_dir, "plots", jobid, f"Templates_{analyzer}", args.lepton)
...
templates_names = {
    "3Jets" : {
        "bkg" : {
            ...
            "Smooth" : load(os.path.join(input_dir, f"test_CombinedSmoothed_templates_lj_3Jets_bkg_{jobid}.coffea")),
            "Flat" : load(os.path.join(input_dir, f"test_CombinedFlattened_templates_lj_3Jets_bkg_{jobid}.coffea")),
            },
        "sig" : {
            "Orig" : load(os.path.join(input_dir, f"test_CombinedRaw_templates_lj_3Jets_sig_{jobid}.coffea")),
            "Smooth" : load(os.path.join(input_dir, f"test_CombinedSmoothed_templates_lj_3Jets_sig_{jobid}.coffea")),
            "Flat" : load(os.path.join(input_dir, f"test_CombinedFlattened_templates_lj_3Jets_sig_{jobid}.coffea")),
            },
    },
    "4PJets" : {
        "bkg" : {
            "Orig" : load(os.path.join(input_dir, f"test_CombinedRaw_templates_lj_4PJets_bkg_{jobid}.coffea")),
            "Smooth" : load(os.path.join(input_dir, f"test_CombinedSmoothed_templates_lj_4PJets_bkg_{jobid}.coffea")),
            "Flat" : load(os.path.join(input_dir, f"test_CombinedFlattened_templates_lj_4PJets_bkg_{jobid}.coffea")),
            },
        "sig" : {
            "Orig" : load(os.path.join(input_dir, f"test_CombinedRaw_templates_lj_4PJets_sig_{jobid}.coffea")),
            "Smooth" : load(os.path.join(input_dir, f"test_CombinedSmoothed_templates_lj_4PJets_sig_{jobid}.coffea")),
            "Flat" : load(os.path.join(input_dir, f"test_CombinedFlattened_templates_lj_4PJets_sig_{jobid}.coffea")),
            },
    },
}
