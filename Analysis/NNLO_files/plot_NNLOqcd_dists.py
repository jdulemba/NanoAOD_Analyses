...
Plotter.plot_2d_norm(hdict=nnlo_histo, xaxis_name=nnlo_histo.dense_axes()[0].name, yaxis_name=nnlo_histo.dense_axes()[1].name,
...
Plotter.plot_2d_norm(hdict=nnlo_histo, xaxis_name=nnlo_histo.dense_axes()[1].name, yaxis_name=nnlo_histo.dense_axes()[0].name,
