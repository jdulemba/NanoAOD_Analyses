...
rname = f"IMPACTSv35_lj_data_A_m400_relw5p0.root"
...
outdir = os.path.join(plot_outdir, jobid, "Limits_htt_btag_sb_regions", os.path.basename(basedir).split(f"{jobid}_")[-1], "prefit", year_label.replace("VFP",""))
