...
class htt_iso_sb(processor.ProcessorABC):
    def __init__(self):
    ...
    def process(self, df):
        ...
        regions = {
            ...
            ## object selection
        objsel_evts = objsel.select(df, year=args.year, corrections=self.corrections, noIso=True, accumulator=output)
