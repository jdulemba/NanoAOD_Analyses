                ...
                for btagregion in regions[lepton][leptype].keys():
                    for jmult in regions[lepton][leptype][btagregion].keys():
                        ...
                        if cut.sum() > 0:
                            ...
                            #set_trace()
                                # fill hists
                            output = self.fill_selection_hists(acc=output, jetmult=jmult, leptype=lepton, lepcat=leptype, btagregion=btagregion, permarray=bp_status[cut][valid_perms][MTHigh], MTcut=MTHigh, perm=best_perms, evt_weights=evt_weights_to_use[cut][valid_perms][MTHigh])
    ...
    def fill_selection_hists(self, acc, jetmult, leptype, lepcat, btagregion, permarray, MTcut, perm, evt_weights):
        ...
        for permval in np.unique(permarray).tolist():
            ...
            for obj in ['TTbar', 'THad', 'TLep', 'BHad', 'BLep', 'WHad', 'WLep', 'Lepton']:
                perm_obj_p4 = perm[obj].p4.flatten()[MTcut]
                acc['BP_pt'    ].fill(dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, objtype=obj, pt=perm_obj_p4.pt[perm_inds], weight=evt_weights[perm_inds])
                acc['BP_eta'   ].fill(dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, objtype=obj, eta=perm_obj_p4.eta[perm_inds], weight=evt_weights[perm_inds])
                acc['BP_phi'   ].fill(dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, objtype=obj, phi=perm_obj_p4.phi[perm_inds], weight=evt_weights[perm_inds])
                acc['BP_mass'  ].fill(dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, objtype=obj, mass=perm_obj_p4.mass[perm_inds], weight=evt_weights[perm_inds])
                acc['BP_energy'].fill(dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, objtype=obj, energy=perm_obj_p4.energy[perm_inds], weight=evt_weights[perm_inds])

            acc['mtt'].fill(     dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, mtt=ttbar_p4.mass[perm_inds], weight=evt_weights[perm_inds])
            acc['mthad'].fill(   dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, mtop=thad_p4.mass[perm_inds], weight=evt_weights[perm_inds])
            acc['pt_thad'].fill( dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, pt=thad_p4.pt[perm_inds], weight=evt_weights[perm_inds])
            acc['pt_tt'].fill(   dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, pt=ttbar_p4.pt[perm_inds], weight=evt_weights[perm_inds])
            acc['eta_thad'].fill(dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, eta=thad_p4.eta[perm_inds], weight=evt_weights[perm_inds])
            acc['eta_tt'].fill(  dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, eta=ttbar_p4.eta[perm_inds], weight=evt_weights[perm_inds])

            acc['tlep_ctstar'].fill(    dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, ctstar=tlep_ctstar[perm_inds], weight=evt_weights[perm_inds])
            acc['tlep_ctstar_abs'].fill(dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, ctstar_abs=np.abs(tlep_ctstar[perm_inds]), weight=evt_weights[perm_inds])

            acc['full_disc'].fill(dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, prob=perm['Prob'].flatten()[MTcut][perm_inds], weight=evt_weights[perm_inds])
            acc['mass_disc'].fill(dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, massdisc=perm['MassDiscr'].flatten()[MTcut][perm_inds], weight=evt_weights[perm_inds])
            acc['ns_disc'].fill(  dataset=dataset_name, jmult=jetmult, leptype=leptype, lepcat=lepcat, btag=btagregion, nsdisc=perm['NuDiscr'].flatten()[MTcut][perm_inds], weight=evt_weights[perm_inds])
