                        ...
                        for jmult in regions[lepton][leptype][btagregion].keys():
                            ...
                            if cut.sum() > 0:
                                ...
                                if isTTbar_:
                                    ...
                                    sl_tau_evts = (np.abs(GenTTbar['SL']['Lepton'].pdgId) == 15).flatten()
                                ...
                                if isTTbar_:
                                    ...
                                    #set_trace()
                                        # semileptonic decays
                                    passing_SL = GenTTbar['SL'][cut][valid_perms][MTHigh]
                                    decay_wts = evt_weights_to_use[cut][valid_perms][MTHigh]
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='SL e', nevts=np.ones((np.abs(passing_SL['Lepton'].pdgId) == 11).sum().sum()), weight=decay_wts[(np.abs(passing_SL['Lepton'].pdgId) == 11).flatten()])
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='SL mu', nevts=np.ones((np.abs(passing_SL['Lepton'].pdgId) == 13).sum().sum()), weight=decay_wts[(np.abs(passing_SL['Lepton'].pdgId) == 13).flatten()])
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='SL tau', nevts=np.ones((np.abs(passing_SL['Lepton'].pdgId) == 15).sum().sum()), weight=decay_wts[(np.abs(passing_SL['Lepton'].pdgId) == 15).flatten()])
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='SL tau->l', nevts=np.ones((passing_SL['Lepton'].decaytype == 1).sum().sum()), weight=decay_wts[(passing_SL['Lepton'].decaytype == 1).flatten()])
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='SL tau->h', nevts=np.ones((passing_SL['Lepton'].decaytype == 2).sum().sum()), weight=decay_wts[(passing_SL['Lepton'].decaytype == 2).flatten()])
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='SL Total', nevts=np.ones((passing_SL['Lepton'].counts.sum())), weight=decay_wts[passing_SL['Lepton'].counts > 0])
                            
                                    #set_trace()                                                                
                                        # dileptonic decays
                                    passing_DL = GenTTbar['DL'][cut][valid_perms][MTHigh]
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='DL e e', nevts=np.ones((((np.abs(passing_DL['First_plus'].pdgId) == 11) & (np.abs(passing_DL['First_minus'].pdgId) == 11)).sum().sum())), weight=decay_wts[((np.abs(passing_DL['First_plus'].pdgId) == 11) & (np.abs(passing_DL['First_minus'].pdgId) == 11)).flatten()])
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='DL e mu', nevts=np.ones(((((np.abs(passing_DL['First_plus'].pdgId) == 11) & (np.abs(passing_DL['First_minus'].pdgId) == 13)) | ((np.abs(passing_DL['First_plus'].pdgId) == 13) & (np.abs(passing_DL['First_minus'].pdgId) == 11))).sum().sum())), weight=decay_wts[(((np.abs(passing_DL['First_plus'].pdgId) == 11) & (np.abs(passing_DL['First_minus'].pdgId) == 13)) | ((np.abs(passing_DL['First_plus'].pdgId) == 13) & (np.abs(passing_DL['First_minus'].pdgId) == 11))).flatten()])
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='DL e tau->l', nevts=np.ones(((((np.abs(passing_DL['First_plus'].pdgId) == 11) & ((np.abs(passing_DL['First_minus'].pdgId) == 15) & (passing_DL['First_minus'].decaytype == 1))) | ((np.abs(passing_DL['First_minus'].pdgId) == 11) & ((np.abs(passing_DL['First_plus'].pdgId) == 15) & (passing_DL['First_plus'].decaytype == 1)))).sum().sum())), weight=decay_wts[(((np.abs(passing_DL['First_plus'].pdgId) == 11) & ((np.abs(passing_DL['First_minus'].pdgId) == 15) & (passing_DL['First_minus'].decaytype == 1))) | ((np.abs(passing_DL['First_minus'].pdgId) == 11) & ((np.abs(passing_DL['First_plus'].pdgId) == 15) & (passing_DL['First_plus'].decaytype == 1)))).flatten()])
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='DL e tau->h', nevts=np.ones(((((np.abs(passing_DL['First_plus'].pdgId) == 11) & ((np.abs(passing_DL['First_minus'].pdgId) == 15) & (passing_DL['First_minus'].decaytype == 2))) | ((np.abs(passing_DL['First_minus'].pdgId) == 11) & ((np.abs(passing_DL['First_plus'].pdgId) == 15) & (passing_DL['First_plus'].decaytype == 2)))).sum().sum())), weight=decay_wts[(((np.abs(passing_DL['First_plus'].pdgId) == 11) & ((np.abs(passing_DL['First_minus'].pdgId) == 15) & (passing_DL['First_minus'].decaytype == 2))) | ((np.abs(passing_DL['First_minus'].pdgId) == 11) & ((np.abs(passing_DL['First_plus'].pdgId) == 15) & (passing_DL['First_plus'].decaytype == 2)))).flatten()])
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='DL mu mu', nevts=np.ones((((np.abs(passing_DL['First_plus'].pdgId) == 13) & (np.abs(passing_DL['First_minus'].pdgId) == 13)).sum().sum())), weight=decay_wts[((np.abs(passing_DL['First_plus'].pdgId) == 13) & (np.abs(passing_DL['First_minus'].pdgId) == 13)).flatten()])
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='DL mu tau->l', nevts=np.ones(((((np.abs(passing_DL['First_plus'].pdgId) == 13) & ((np.abs(passing_DL['First_minus'].pdgId) == 15) & (passing_DL['First_minus'].decaytype == 1))) | ((np.abs(passing_DL['First_minus'].pdgId) == 13) & ((np.abs(passing_DL['First_plus'].pdgId) == 15) & (passing_DL['First_plus'].decaytype == 1)))).sum().sum())), weight=decay_wts[(((np.abs(passing_DL['First_plus'].pdgId) == 13) & ((np.abs(passing_DL['First_minus'].pdgId) == 15) & (passing_DL['First_minus'].decaytype == 1))) | ((np.abs(passing_DL['First_minus'].pdgId) == 13) & ((np.abs(passing_DL['First_plus'].pdgId) == 15) & (passing_DL['First_plus'].decaytype == 1)))).flatten()])
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='DL mu tau->h', nevts=np.ones(((((np.abs(passing_DL['First_plus'].pdgId) == 13) & ((np.abs(passing_DL['First_minus'].pdgId) == 15) & (passing_DL['First_minus'].decaytype == 2))) | ((np.abs(passing_DL['First_minus'].pdgId) == 13) & ((np.abs(passing_DL['First_plus'].pdgId) == 15) & (passing_DL['First_plus'].decaytype == 2)))).sum().sum())), weight=decay_wts[(((np.abs(passing_DL['First_plus'].pdgId) == 13) & ((np.abs(passing_DL['First_minus'].pdgId) == 15) & (passing_DL['First_minus'].decaytype == 2))) | ((np.abs(passing_DL['First_minus'].pdgId) == 13) & ((np.abs(passing_DL['First_plus'].pdgId) == 15) & (passing_DL['First_plus'].decaytype == 2)))).flatten()])
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='DL tau tau->ll', nevts=np.ones(((((np.abs(passing_DL['First_plus'].pdgId) == 15) & (passing_DL['First_plus'].decaytype == 1)) & ((np.abs(passing_DL['First_minus'].pdgId) == 15) & (passing_DL['First_minus'].decaytype == 1))).sum().sum())), weight=decay_wts[(((np.abs(passing_DL['First_plus'].pdgId) == 15) & (passing_DL['First_plus'].decaytype == 1)) & ((np.abs(passing_DL['First_minus'].pdgId) == 15) & (passing_DL['First_minus'].decaytype == 1))).flatten()])
                                    ...
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='DL tau tau->hh', nevts=np.ones(((((np.abs(passing_DL['First_plus'].pdgId) == 15) & (passing_DL['First_plus'].decaytype == 2)) & ((np.abs(passing_DL['First_minus'].pdgId) == 15) & (passing_DL['First_minus'].decaytype == 2))).sum().sum())), weight=decay_wts[(((np.abs(passing_DL['First_plus'].pdgId) == 15) & (passing_DL['First_plus'].decaytype == 2)) & ((np.abs(passing_DL['First_minus'].pdgId) == 15) & (passing_DL['First_minus'].decaytype == 2))).flatten()])
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='DL Total', nevts=np.ones((passing_DL['First_plus'].counts.sum())), weight=decay_wts[(passing_DL['First_plus'].counts > 0)])
                            
                                        # all hadronic decays
                                    passing_Had = GenTTbar['Had'][cut][valid_perms][MTHigh]
                                    output['tt_decay'].fill(dataset=self.sample_name, sys='nosys', jmult=jmult, leptype=lepton, lepcat=leptype, btag=btagregion, ttdecay='Had Total', nevts=np.ones((passing_Had['First_plus'].counts.sum())), weight=decay_wts[passing_Had['First_plus'].counts > 0])
