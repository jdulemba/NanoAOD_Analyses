...
combine_template_sys_to_name = {
    ...
    year : {
        ...
        "Lep_RECOUp"   : "CMS_eff_LEP_recoUp",
        "Lep_RECODown" : "CMS_eff_LEP_recoDown",
...
template_sys_to_name = {
    ...
    year : {
        "nosys" : "",
        "JES_Absolute_UP" : "JesAbsoluteCorrUp",
        "JES_Absolute_DW" : "JesAbsoluteCorrDown",
        #"JES_Absolute_UP" : "JesAbsoluteUp",
        #"JES_Absolute_DW" : "JesAbsoluteDown",
        f"JES_Absolute_{year}_UP" : f"JesAbsoluteUncorrUp",
        f"JES_Absolute_{year}_DW" : f"JesAbsoluteUncorrDown",
        #f"JES_Absolute_{year}_UP" : f"JesAbsolute{year}Up",
        #f"JES_Absolute_{year}_DW" : f"JesAbsolute{year}Down",
        "JES_BBEC1_UP" : "JesBBEC1CorrUp",
        "JES_BBEC1_DW" : "JesBBEC1CorrDown",
        #"JES_BBEC1_UP" : "JesBBEC1Up",
        #"JES_BBEC1_DW" : "JesBBEC1Down",
        f"JES_BBEC1_{year}_UP" : f"JesBBEC1UncorrUp",
        f"JES_BBEC1_{year}_DW" : f"JesBBEC1UncorrDown",
        #f"JES_BBEC1_{year}_UP" : f"JesBBEC1{year}Up",
        #f"JES_BBEC1_{year}_DW" : f"JesBBEC1{year}Down",
        f"JES_RelativeSample_{year}_UP" : f"JesRelativeSampleUncorrUp",
        f"JES_RelativeSample_{year}_DW" : f"JesRelativeSampleUncorrDown",
        #f"JES_RelativeSample_{year}_UP" : f"JesRelativeSample{year}Up",
        #f"JES_RelativeSample_{year}_DW" : f"JesRelativeSample{year}Down",
        ...
        "Lep_IDtotUp" : "LEPsfIDtotUp",
        "Lep_IDtotDown" : "LEPsfIDtotDown",
        "Lep_IDstatUp" : "LEPsfIDstatUp",
        "Lep_IDstatDown" : "LEPsfIDstatDown",
        "Lep_IDsystUp" : "LEPsfIDsystUp",
        "Lep_IDsystDown" : "LEPsfIDsystDown",
        "Lep_ISOtotUp" : "LEPsfISOtotUp",
        "Lep_ISOtotDown" : "LEPsfISOtotDown",
        "Lep_ISOstatUp" : "LEPsfISOstatUp",
        "Lep_ISOstatDown" : "LEPsfISOstatDown",
        "Lep_ISOsystUp" : "LEPsfISOsystUp",
        "Lep_ISOsystDown" : "LEPsfISOsystDown",
        "Lep_TRIGtotUp" : "LEPsfTRIGtotUp",
        "Lep_TRIGtotDown" : "LEPsfTRIGtotDown",
        "Lep_TRIGstatUp" : "LEPsfTRIGstatUp",
        "Lep_TRIGstatDown" : "LEPsfTRIGstatDown",
        "Lep_TRIGsystUp" : "LEPsfTRIGsystUp",
        "Lep_TRIGsystDown" : "LEPsfTRIGsystDown",
        "Lep_RECOtotUp" : "LEPsfRECOtotUp",
        "Lep_RECOtotDown" : "LEPsfRECOtotDown",
