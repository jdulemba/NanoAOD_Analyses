...
template_sys_to_name = {
    ...
    year : {
        "nosys" : "",
        "JES_Absolute_UP" : "JesAbsoluteUp", "JES_Absolute_DW" : "JesAbsoluteDown",
        f"JES_Absolute_{year}_UP" : f"JesAbsolute{year}Up", f"JES_Absolute_{year}_DW" : f"JesAbsolute{year}Down",
        "JES_BBEC1_UP" : "JesBBEC1Up", "JES_BBEC1_DW" : "JesBBEC1Down",
        f"JES_BBEC1_{year}_UP" : f"JesBBEC1{year}Up", f"JES_BBEC1_{year}_DW" : f"JesBBEC1{year}Down",
        f"JES_RelativeSample_{year}_UP" : f"JesRelativeSample{year}Up", f"JES_RelativeSample_{year}_DW" : f"JesRelativeSample{year}Down",
